...
def pcl_callback(pcl_msg):
    ...
    cloud_filtered1 = cloud_filtered
    ...
    cloud_filtered3 = cloud_filtered
    ...
    cloud_filtered4 = cloud_filtered
    ...
    ros_cloud_try = pcl_to_ros(cloud_filtered4)

    # Publish the ROS messages
    pcl_objects_pub.publish(ros_cloud_objects)
    pcl_table_pub.publish(ros_cloud_table)
    pcl_cluster_pub.publish(ros_cluster_cloud)
    pcl_try.publish(ros_cloud_try)
...
if __name__ == '__main__':
    ...
    pcl_try = rospy.Publisher("/pcl_try", PointCloud2, queue_size=1)
